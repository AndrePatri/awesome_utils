...
void RotDynCal::set_ig(Eigen::VectorXd& ig_Kd0,
                     Eigen::VectorXd& ig_Kd1)
{
    // check on ig dimensions
    int err = 0;
...
void RotDynCal::get_current_optimal_Kd(Eigen::VectorXd& Kd0_opt,
                                     Eigen::VectorXd& Kd1_opt)
...
void RotDynCal::compute_tau_friction()
{
    for (int i = 0; i < _n_jnts; i++)
    {
...
void RotDynCal::get_current_tau_total(Eigen::VectorXd& tau_total)
{
    // just in case the user provides uninitialized vector
    // or vector of wrong dimension
...
void RotDynCal::get_current_tau_friction(Eigen::VectorXd& tau_friction)
{
    // just in case the user provides uninitialized vector
    // or vector of wrong dimension
...
void RotDynCal::get_current_alpha(Eigen::VectorXd& alpha_d0, Eigen::VectorXd& alpha_d1)
{
